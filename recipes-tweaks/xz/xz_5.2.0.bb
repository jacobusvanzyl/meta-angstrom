...
LICENSE:liblzma = "PD"
LICENSE:liblzma-dev = "PD"
LICENSE:liblzma-staticdev = "PD"
LICENSE:liblzma-dbg = "PD"
...
EXTRA_OECONF:x86 = " --enable-assembler=x86"
EXTRA_OECONF:x86-84 = " --enable-assembler=x86_64"

PACKAGES =+ "liblzma liblzma-dev liblzma-staticdev liblzma-dbg"

FILES:liblzma = "${libdir}/liblzma*${SOLIBS}"
FILES:liblzma-dev = "${includedir}/lzma* ${libdir}/liblzma*${SOLIBSDEV} ${libdir}/liblzma.la ${libdir}/pkgconfig/liblzma.pc"
FILES:liblzma-staticdev = "${libdir}/liblzma.a"
FILES:liblzma-dbg = "${libdir}/.debug/liblzma*"
